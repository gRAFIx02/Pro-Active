...
INSERT INTO `exercise_info` VALUES ('Declined Pushup','Calisthenics','Chest','Elevate your legs and keeps your hands on the floor. This elevation increases the intensity of the pushup, making it harder in every rep.','../image/exercise/declined-pushup.jpg','Intermediate'),('Diamon Pushup','Calisthenics','Triceps','Form a diamond shape using your palms. Spread your legs wide, and perform pushups.','../image/exercise/diamond-pushup.jpg','Intermediate'),('Floating Pushup','Calisthenics','Shoulder','Elevate yourself a little using a pushup bar or a platorm, then lift your legs up like a floating plank. From that positiion, perform pushups without dropping your legs on the floor.','../image/exercise/floating-pushup.jpg','Extreme'),('Handstand Pushup','Calisthenics','Shoulder','Perform a handstand or a supported handstand, then perform pushups.','../image/exercise/handstand-pushup.jpg','Extreme'),('Inclined Pushup','Calisthenics','Triceps','Elevate yourself from the ground using a platform (chair, table, bench, etc.) and perform pushups.','../image/exercise/inlcined-pushup.jpg','Beginner'),('One Arm Pushup','Calisthenics','Chest','Pushup using one arm. Keep the legs spread wide for good balance.','../image/exercise/onearm-pushup.jpg','Advanced'),('Pushup','Calisthenics','Triceps','Regular pushups. Go down slow, and explode up.','../image/exercise/pushup.jpg','Intermediate'),('Superman Pushup','Calisthenics','Chest','Perform a pushup, and then explode up. When you are up, spread your hands and legs like a superman flies.','../image/exercise/superman-pushup.jpg','Advanced'),('Wall Pushup','Calisthenics','Triceps','Perform pushup using the wall as support.','../image/exercise/wall-pushup.jpg','Beginner');
...
INSERT INTO `trainer_info` VALUES ('ProtyRaf','$2b$10$CrZOQ71bmDoGUjDzGtcnmOUfqQl..hQ2tP1GkS2bJbVtD0/TyGN/G','prottoyrafi@iut-dhaka.edu',22,180,70,'calisthenics','Prottoy Rafi'),('ssdsd','$2b$10$AL9yakR6//WEVGXMry1dlu9q1tXvnV3.q4KvyeXtsdyWGAuGbdHl.','s@GMAIL.COM',1,1,-3,'','s'),('taf','$2b$10$aAEkVGeDxJ/8n9T305YyfunBpY3xiQIibes4T0zGvF5duMV4rpgJ.','23@gmail.com',22,22,222,'calisthenics','ere'),('Tam1','$2b$10$LvL96eFifH.PpjTMnDkdTeNonRzNhlorydcR8BLX2C26kr1iPNCEy','1233@gmail.com',22,222,222,'calisthenics','Tam1'),('Tam37','$2b$10$njJO2ZhMia.XJGjVsc5rs.dyS3EZDPVR3QYSq2.SBrAjC4KEHjomu','190041237tr@gmail.com',22,200,70,'weighlifting','Tahmid Rahman');
...
-- Dump completed on 2022-11-18 14:19:17
