...
import { register, login, verifyToken, logout,trainer_register,trainerlogin, verifyToken1,logout1,plansperday,getplansperday1,nutritionsperday, getnutritionperday1, addtips, addplan1, addplan2, plansperday1, getplansperday2, changepass, changepass1} from "./middlewares/auth/auth.js";
...
app.post("/changeuserpass",bypassCORS,verifyToken,changepass);

app.post("/changetrainerpass",bypassCORS,verifyToken,changepass1);
